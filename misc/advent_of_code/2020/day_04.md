...
## Day 4 - Passport Processing - 12/4/2020
...
```javascript
// Input: string representing batch passport file
// Output: number representing how many passports in the batch file are valid
// Rules/Implicit Knowledge
//   valid passport has all required fields:
//     byr (Birth Year)
//     iyr (Issue Year)
//     eyr (Expiration Year)
//     hgt (Height)
...
//     ecl (Eye Color)
//     pid (Passport ID)
//     cid (Country ID) - temporarily optional per problem description
//   batch file:
//     passports separated by blank lines
//     fields separated by spaces or newlines
//     field names and filed values separated by colons
// Examples: see below
// Edge Cases
// Data Structure: parse batch file string to array of objects
// Algorithm
//   isValid (separate function - takes passport object)
//     constant: required fields
//     iterate required fields (use block for potential early return)
//       if passport object does not have current required field return false
//     return true
//
//   parse batchFile to array of objects (separate function - takes batchFile string)
//     split string on blank lines to array of strings/passports
//     map array of passport strings to array of passport objects and return it
//       initialize passport object
//       split passport string on space or newline to array of key:value pairs
//       iterate array of key:value pairs
//         split on : to key and value
//         insert into passport object
//       return passport object
//
//   parse batchFile string to array of passport objects with function
//   filter array of passport objects by isValid function
//   return length of filtered array
// Code

let isValid = function isValid(passport) {
  const requiredFields = ['byr', 'iyr', 'eyr', 'hgt', 'hcl', 'ecl', 'pid'];

  for (let field of requiredFields) {
    if (passport[field] === undefined) return false;
  }

  return true;
};

let parsePassports = function parsePassports(batchFile) {
  const PASSPORT_SEPARATOR = '\n\n';
  const FIELD_SEPARATOR = / |\n/;
  const KEY_VALUE_SEPARATOR = `:`;

  let passports = batchFile.split(PASSPORT_SEPARATOR);

  return passports.map(passportString => {
    const passportObj = {};

    passportString.split(FIELD_SEPARATOR).forEach(field => {
      let [key, value] = field.split(KEY_VALUE_SEPARATOR);
...
let countValidPassports = function countValidPassports(batchFile) {
  let passports = parsePassports(batchFile);
  return passports.filter(isValid).length;
};

const batchFile = 'ecl:gry pid:860033327 eyr:2020 hcl:#fffffd\n' +
                  'byr:1937 iyr:2017 cid:147 hgt:183cm\n' +
                  '\n' +
                  'iyr:2013 ecl:amb cid:350 eyr:2023 pid:028048884\n' +
                  'hcl:#cfa07d byr:1929\n' +
...
console.log(countValidPassports(batchFile) === 2);
```
...
```javascript
let isValidBirthYear = function isValidBirthYear(year) {
  const MIN = 1920;
  const MAX = 2002;

  return Number(year) >= MIN && Number(year) <= MAX;
};

// console.log(isValidBirthYear('900') === false);
// console.log(isValidBirthYear('1900') === false);
// console.log(isValidBirthYear('1919') === false);
// console.log(isValidBirthYear('1920') === true);
// console.log(isValidBirthYear('1967') === true);
// console.log(isValidBirthYear('2001') === true);
// console.log(isValidBirthYear('2002') === true);
// console.log(isValidBirthYear('2003') === false);
// console.log(isValidBirthYear('52003') === false);

let isValidIssueYear = function isValidIssueYear(year) {
  const MIN = 2010;
  const MAX = 2020;
...
// console.log(isValidIssueYear('900') === false);
// console.log(isValidIssueYear('1900') === false);
// console.log(isValidIssueYear('2009') === false);
// console.log(isValidIssueYear('2010') === true);
// console.log(isValidIssueYear('2014') === true);
// console.log(isValidIssueYear('2019') === true);
// console.log(isValidIssueYear('2020') === true);
// console.log(isValidIssueYear('2021') === false);
// console.log(isValidIssueYear('52003') === false);

let isValidExpirationYear = function isValidExpirationYear(year) {
  const MIN = 2020;
  const MAX = 2030;
...
// console.log(isValidExpirationYear('900') === false);
// console.log(isValidExpirationYear('1900') === false);
// console.log(isValidExpirationYear('2019') === false);
// console.log(isValidExpirationYear('2020') === true);
// console.log(isValidExpirationYear('2021') === true);
// console.log(isValidExpirationYear('2029') === true);
// console.log(isValidExpirationYear('2030') === true);
// console.log(isValidExpirationYear('2031') === false);
// console.log(isValidExpirationYear('52003') === false);

let isValidHeight = function isValidHeight(height) {
  const MIN_CM = 150;
  const MAX_CM = 193;
  const MIN_IN = 59;
  const MAX_IN = 76;
  ...
  switch (unit) {
    case 'cm': return height >= MIN_CM && height <= MAX_CM;
    case 'in': return height >= MIN_IN && height <= MAX_IN;
    default: return false;
  };
};

// console.log(isValidHeight('2cm') === false);
// console.log(isValidHeight('149cm') === false);
// console.log(isValidHeight('150cm') === true);
// console.log(isValidHeight('172cm') === true);
// console.log(isValidHeight('193cm') === true);
// console.log(isValidHeight('194cm') === false);
// console.log(isValidHeight('2194cm') === false);

// console.log(isValidHeight('2in') === false);
// console.log(isValidHeight('58in') === false);
// console.log(isValidHeight('59in') === true);
// console.log(isValidHeight('62in') === true);
// console.log(isValidHeight('76in') === true);
// console.log(isValidHeight('77in') === false);
// console.log(isValidHeight('2194in') === false);

let isValidHairColor = function isValidHairColor(hairColor) {
  return /^#[0-9a-f]{6}$/.test(hairColor);
};

// console.log(isValidHairColor('#012456') === true);
// console.log(isValidHairColor('#abcdef') === true);
// console.log(isValidHairColor('#0a2b5c') === true);
// console.log(isValidHairColor('#5012456') === false);
// console.log(isValidHairColor('#abcdefa') === false);
// // console.log(isValidHairColor('#abcdeg') === false);
// console.log(isValidHairColor('#ABCDEG') === false);

let isValidEyeColor = function isValidEyeColor(eyeColor) {
...
// console.log(isValidEyeColor('amb') === true);
// console.log(isValidEyeColor('blu') === true);
// console.log(isValidEyeColor('brn') === true);
// console.log(isValidEyeColor('gry') === true);
// console.log(isValidEyeColor('grn') === true);
// console.log(isValidEyeColor('hzl') === true);
// console.log(isValidEyeColor('oth') === true);
// console.log(isValidEyeColor('other') === false);
// console.log(isValidEyeColor('green') === false);
// console.log(isValidEyeColor('BLU') === false);

let isValidPassportID = function isValidPassportID(pid) {
  return /^\d{9}$/.test(pid);
};

// console.log(isValidPassportID('012345678') === true);
// console.log(isValidPassportID('912345678') === true);
// console.log(isValidPassportID('000000678') === true);
// console.log(isValidPassportID('0123 5678') === false);
// console.log(isValidPassportID('0123-5678') === false);
// console.log(isValidPassportID('a00000678') === false);
// console.log(isValidPassportID('abcdefghi') === false);
...
let isValid = function isValid(passport) {
  ...
  for (let field in requiredFields) {
    ...
    let validationFunc = requiredFields[field];
    if (!validationFunc(passport[field])) return false;
  }

  return true;
};

const batchFile ='eyr:1972 cid:100\n' +
                 'hcl:#18171d ecl:amb hgt:170 pid:186cm iyr:2018 byr:1926\n' +
                 '\n' +
                 'iyr:2019\n' +
                 'hcl:#602927 eyr:1967 hgt:170cm\n' +
...
console.log(countValidPassports(batchFile) === 4);
```
