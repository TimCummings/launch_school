...
class PigLatinTest < Minitest::Test
  ...
  def test_non_string_input
    assert_raises(ArgumentError) { PigLatin.translate(87) }
  end

  def test_invalid_characters
    message = "Discarding invalid characters.\n"
    actual = ''
    assert_output(message) { actual = PigLatin.translate('12 green eggs') }
    assert_equal('eengray eggsay', actual)
  end
end
